$(document).ready(function () {
  ...
  function showAlert(message) {
    var alertDiv = $(
      '<div class="alert alert-danger alert-dismissible mt-3" role="alert" style="position: fixed; font-family: Nunito; top: -100px; left: 50%; transform: translateX(-50%); transition: top 0.5s ease-in-out;">' +
        message +
  ...
  function showSuccess(message) {
    var successDiv = $(
      '<div id="success-alert" class="alert alert-success mt-3" style="font-family: Nunito; position: fixed; top: -100px; left: 50%; transform: translateX(-50%); transition: top 0.5s ease-in-out;">' +
        message +
        "</div>"
    );
